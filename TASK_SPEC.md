...
## Acceptance Criteria
- [x] `npm run storybook` launches Storybook on port 6006
- [x] `npx storybook build` produces static build without errors
- [x] Button story renders correctly in both light and dark mode
- [x] Global decorator applies Tailwind styles matching dashboard appearance
- [x] Storybook uses same `tailwind.config.ts` as dashboard
- [x] No changes to existing source code or tests
