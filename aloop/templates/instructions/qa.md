...
1. **Select Test Targets**
   - Pick 3-5 features to test this session using the **Priority Selection Algorithm**:
   ...
   - **Never test a `PASS` feature if `UNTESTED` features remain** (unless it's a smoke test)
