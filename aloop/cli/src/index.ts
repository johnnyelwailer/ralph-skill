...
program
  ...
  .option('--triage-interval <n>', 'Run triage every N scan iterations (default: 5)')
  .option('--rate-limit-backoff <strategy>', 'Rate limit backoff strategy: exponential, linear, or fixed (default: fixed)')
  .option('--child-max-iterations <n>', 'Max iterations for child loops (default: unlimited)')
