...
describe('App.tsx AppView integration coverage', () => {
  ...
  it('covers Sidebar exhaustive', () => {
    ...
    const { container } = render(createElement(TooltipProvider, undefined, createElement(Sidebar, {
  ...
  it('covers ActivityPanel and LogEntryRow exhaustive', async () => {
    ...
    render(createElement(TooltipProvider, undefined, createElement(ActivityPanel, {
      log,
  ...
  it('covers DocContent and HealthPanel', () => {
    ...
    render(createElement(TooltipProvider, undefined, createElement(HealthPanel, { providers: providers as any[] })));
    expect(screen.getByText('p1')).toBeInTheDocument();
  });
});
