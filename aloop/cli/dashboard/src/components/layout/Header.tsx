...
import {
  ConnectionIndicator, ElapsedTimer, PhaseBadge, StatusDot,
  ...
  return (
    <header className="border-b border-border px-3 py-2 md:px-4 md:py-2.5 shrink-0">
      ...
      <div className="flex items-center gap-2 sm:gap-4" data-testid="session-header-grid">
        ...
        {/* Iteration info — hidden on mobile */}
        <HoverCard>
...
export { ConnectionIndicator, ElapsedTimer, PhaseBadge, StatusDot } from './StatusIndicators';
export { QACoverageBadge } from './QACoverageBadge';
