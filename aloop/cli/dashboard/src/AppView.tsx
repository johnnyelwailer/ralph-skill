...
import {
  ...
  GitBranch, GitCommit, FileText, PanelLeftClose,
  PanelLeftOpen, Play, Send, Square, Terminal, Timer, XCircle, Zap, Loader2,
} from 'lucide-react';
...
import {
  Header, QACoverageBadge, PhaseBadge, StatusDot, ConnectionIndicator, ElapsedTimer,
} from '@/components/layout/Header';
import type { ConnectionStatus } from '@/components/layout/Header';
import { Footer } from '@/components/layout/Footer';
import { DocsPanel, DocContent, HealthPanel } from '@/components/layout/DocsPanel';
import { renderAnsiToHtml } from '@/lib/ansi';
import {
  formatTime, formatTimeShort, formatSecs, formatDuration, formatDateKey, relativeTime, formatTokenCount,
} from '@/lib/formatters';
import {
  isRecord, str, numStr, toSession, parseLogLine, extractIterationUsage,
  isImageArtifact, artifactUrl, parseManifest, extractModelFromOutput,
  computeAvgDuration, latestQaCoverageRefreshSignal, deriveProviderHealth,
  slugify, findBaselineIterations,
} from '@/lib/log';
import type {
  ArtifactManifest, DashboardState, SessionSummary, LogEntry,
  ArtifactEntry, ManifestPayload, ProviderHealth, CostSessionResponse, IterationUsage,
} from '@/lib/log';

// ── Re-exports for backward compatibility (App.test.tsx imports from ./AppView) ──
export { stripAnsi, rgbStr, parseAnsiSegments, renderAnsiToHtml } from '@/lib/ansi';
export { formatTime, formatTimeShort, formatSecs, formatDuration, formatDateKey, relativeTime, formatTokenCount } from '@/lib/formatters';
export {
  isRecord, str, numStr, toSession, SIGNIFICANT_EVENTS, parseLogLine,
  extractIterationUsage, IMAGE_EXT, isImageArtifact, artifactUrl, parseManifest,
  extractModelFromOutput, parseDurationSeconds, computeAvgDuration,
  deriveProviderHealth, slugify, findBaselineIterations,
} from '@/lib/log';
export type { ArtifactManifest, SessionSummary, LogEntry, ArtifactEntry, ManifestPayload, ProviderHealth, IterationUsage } from '@/lib/log';
export { Footer } from '@/components/layout/Footer';
export { DocsPanel, DocContent, HealthPanel } from '@/components/layout/DocsPanel';
