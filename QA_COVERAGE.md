...
| Branch sync automated test coverage | 2026-04-16 | 480100e5 | FAIL | No branch_sync.* branches registered in coverage JSON (52 branches total, none for branch_sync.conflict/success/fetch_fail). Acceptance criteria requires automated coverage for branch-sync conflict branches. Open medium TODO task. |
| Steering reset automated test coverage | 2026-04-16 | 480100e5 | FAIL | No queue.steer_reset / queue.nonsteer_no_reset branches in coverage JSON. Acceptance criteria requires automated coverage. Open medium TODO task. |
