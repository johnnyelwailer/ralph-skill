...
| processPrLifecycle: needs_rebase=true on CONFLICTING (first attempt) | 2026-03-24 | 35b6bd2c | PASS | "requests rebase on first merge conflict" passes; needs_redispatch=true, rebase_attempts=1 |
...
| Redispatch path: needs_rebase=true → 000-rebase-conflict.md with agent:merge | 2026-03-24 | 35b6bd2c | never | No test exists for this path yet (TODO.md lists it as outstanding) |
| Redispatch path: needs_rebase=false → 000-review-fixes.md with agent:build | 2026-03-24 | 35b6bd2c | never | No test exists for this path yet (TODO.md lists it as outstanding) |
