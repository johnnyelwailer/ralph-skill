...
|---------|-------------|--------|--------|-------|
| flock-based lock acquire/release | 2026-03-31 | a4ed87d | PASS | All 7 unit tests pass (source + installed binary) — re-confirmed at HEAD after README fix |
| Stale .lock directory cleanup | 2026-03-31 | a4ed87d | PASS | ensure_provider_health_dir() removes old mkdir dirs — confirmed against installed binary |
...
| loop.sh bundled in npm package | 2026-03-31 | a4ed87d | PASS | dist/bin/loop.sh present with all flock functions |
| No mkdir-based lock acquisition | 2026-03-31 | a4ed87d | PASS | mkdir only for cleanup of stale dirs, not for locking |
