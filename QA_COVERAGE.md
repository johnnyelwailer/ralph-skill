...
| SPEC.md loop-plan.json example: loopSettings field | 2026-03-30 | 89534441b | FAIL | Example at lines 3638-3653 still missing loopSettings. Open TODO.md item (P3). |
