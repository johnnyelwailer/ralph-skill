...
| QACoverageBadge.tsx branch coverage tests | 2026-04-14 | f0692311 | PASS | 5/5 tests pass: green tone (≥80%), red tone (<50%), N/A (available:false), parseQACoveragePayload non-record, percentage fallback |
| Dashboard vitest suite (all tests) | 2026-04-14 | f0692311 | PASS | 274/274 tests pass across 26 test files (up from 269 — 5 new QACoverageBadge tests added) |
