...
| Steering reset automated test coverage | 2026-04-16 | 6e260640 | FAIL | queue.steer_reset / queue.nonsteer_no_reset still absent from coverage JSON (55 branches total, queue.* only has empty/success/frontmatter/frontmatter_unavailable). Open TODO task. |
