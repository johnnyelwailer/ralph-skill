...
| CI cli-tests job (`bun test`) | 2026-04-13 | aloop/issue-22 | FAIL | `bun test` uses Bun's native runner; tests use `node:test` format → NotImplementedError on all TS test files. Bug filed [qa/P1] |
