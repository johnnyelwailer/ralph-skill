...
| process-requests: error handling (non-existent dir) | 2026-03-27 | b71a889a6 | FAIL | silently exits 0 when session dir does not exist — still unfixed |
| process-requests: JSON output mode | 2026-03-27 | ea766e506 | PASS | --output json works, returns scan summary |
| process-requests: diagnostics in JSON output | 2026-03-27 | b71a889a6 | FAIL | --output json does not include diagnostics/blocker summary — still unfixed |
...
| test suite (Gate2+Gate3 assertion strengthening) | 2026-03-27 | b71a889a6 | PASS | 1154 pass, 0 fail, 1 skipped — one more test passing vs prior (cleanStaleSessions no-match branch) |
...
| cleanStaleSessions: no matching child_session branch | 2026-03-27 | b71a889a6 | PASS | orchestrator.json NOT rewritten when stale sessions present but no issue has matching child_session — correct behavior confirmed |
