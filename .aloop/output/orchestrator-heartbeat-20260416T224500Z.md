...
Dispatch requests written at 22:07Z, now ~38 minutes unprocessed:
...
Scheduled heartbeat prompts only — no override prompts.
...
None — existing dispatch requests remain valid. Runtime must process them to launch child sessions.
