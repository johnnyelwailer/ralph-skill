...
# Orchestrator Scan — Iteration 17
...
`process-requests` is not running. The `dispatch-issue-1.json` request has been written but not consumed. No child session exists for issue #1. This has persisted for 17 iterations.
