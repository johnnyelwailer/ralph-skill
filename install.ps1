...
Write-Host "  Claude Code / Codex: /$skillName`:setup  /$skillName`:start  /$skillName`:status  /$skillName`:stop  /$skillName`:steer"
Write-Host "  VS Code Copilot:     /aloop-setup  /aloop-start  /aloop-status  /aloop-stop  /aloop-steer  (prompt files)"
