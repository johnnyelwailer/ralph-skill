...
function errorResponse(status, code, message, details) {
    ...
    return jsonResponse(status, {
        error: { _v: 1, code: code, message: message, details: details },
    });
}
...
function notFoundResponse(path) {
    return errorResponse(404, "not_found", "No route: ".concat(path), { path: path });
}
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (typeof parsed !== "object" || parsed === null || Array.isArray(parsed)) {
                        return [2 /*return*/, { error: badRequest("request body must be a JSON object") }];
                    }
                    obj = parsed;
                    if (obj.data !== undefined && typeof obj.data === "object" && obj.data !== null) {
                        return [2 /*return*/, { data: obj.data }];
                    }
                    return [2 /*return*/, { data: obj }];
                case 2:
                    _a = _b.sent();
                    return [2 /*return*/, { error: badRequest("invalid JSON body") }];
