-- 014-project-workspaces: project-to-workspace many-to-many membership.
-- A project may belong to zero, one, or multiple workspaces.
-- The workspace_projects table (010) provides the forward lookup (workspace -> projects).
-- This table provides the reverse lookup (project -> workspaces) efficiently and
