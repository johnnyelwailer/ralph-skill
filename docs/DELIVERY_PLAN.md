...
- Always-ready scoped multimodal composer that can capture text, links, screenshots, voice notes, documents, and logs; create incubation items; start lightweight research; explain status; and observe launched daemon jobs without owning hidden state.
