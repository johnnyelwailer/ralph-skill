...
- [ ] Add idempotency: track processed request IDs in `requests/processed-ids.json` — load set at start of `processAgentRequests`, skip already-seen IDs with log entry, persist after processing
