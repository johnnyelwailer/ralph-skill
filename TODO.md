...
- [ ] [spec-gap] [P2] `CLAUDE_MODEL` default mismatch between `loop.ps1` and `loop.sh`
...
- [ ] [spec-gap] [P2] SPEC.md acceptance criteria contradiction for Proof Phase (lines 716-717 vs 402-409)
...
- [ ] [spec-gap] [P2] SPEC.md QA Agent description says it runs "after proof" but proof is not in the cycle
...
- [ ] [spec-gap] [P1] `pipeline.yml` referenced in SPEC.md but no such file exists in codebase
