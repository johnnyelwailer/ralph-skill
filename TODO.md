...
- [ ] [review] Gate 4: `useIsTouchLikePointer` hook (dashboard/src/hooks/useIsTouchLikePointer.ts) and its test file are dead code — added but never imported anywhere in the dashboard. Remove both files. (priority: medium)
