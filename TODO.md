...
## Current Phase: Critical Gate Closure + Core Loop/Orchestrator Priorities
...
- [ ] [qa/P2] CLI error handling still leaks stack traces in packaged install for user-facing failures (`aloop start` missing config and invalid argument paths). Re-opened after 2026-03-16 re-test still showed raw JS stack traces. (priority: medium)
- [ ] [qa/P2] `aloop orchestrate --spec NONEXISTENT.md` still leaks stack trace in packaged install. Re-opened after 2026-03-16 re-test FAIL. (priority: medium)
