...
### Completed
- [x] [review] Add test: `severity: 'critical'` branch in diagnostics — pre-seed blocker with `occurrence_count: 9`, assert `severity === 'critical'` after scan pass increments to 10 — `orchestrate.test.ts`. (priority: medium) [reviewed: gates 1-9 pass]
