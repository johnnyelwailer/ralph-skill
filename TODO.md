...
- [x] Replace remaining setup-discovery call sites in command/prompt docs with CLI-based flow (`aloop discover` / `aloop scaffold` / `aloop resolve`) and remove duplicated project-hash/runtime-root instructions. (P0)
