...
- [ ] [dashboard/P1] Regression: log entries missing agent output and artifacts — iteration entries no longer show the agent's output text or linked artifacts (screenshots, proof files). Previously worked with expandable iteration details. (priority: high)
