...
- [x] Add test: request-changes verdict sets `needs_redispatch` flag on issue state — unit test in `orchestrate.test.ts` for `processPrLifecycle` with `request-changes` verdict
