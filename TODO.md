...
- [ ] [review] Gate 4: remove committed debug/repro artifacts `check_argv.mjs` and `reproduce_setup_issue.sh` (added in commit `54372ac`) or wire them into supported tooling/docs; they are currently unreferenced dead artifacts in repository root. (priority: medium)
