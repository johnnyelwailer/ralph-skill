...
> Self-hosted, multi-provider autonomous development harness with a central multimodal agentic composer that turns captured intent into researched, specified, tracked, reviewed, and merged code without continuous human supervision.
