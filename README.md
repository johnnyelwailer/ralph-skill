...
> Self-hosted, multi-provider autonomous development harness with a central agentic composer that turns captured intent into researched, specified, tracked, reviewed, and merged code without continuous human supervision.
